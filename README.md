...
Static marketing site for Bastion (managed DNS content filtering for families, businesses
...
3. Custom domain: the included **`CNAME`** sets `bastion.codeunbound.dev`. Point a DNS
